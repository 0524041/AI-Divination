...
- [ ] 流程骨架共用元件抽出
- [ ] 問事表單（性別/對象/問題聚焦）新樣式＋驗證
- [ ] 銅錢儀式動畫（六擲節奏、跳過、reduced-motion 降級）
- [ ] 揭盤視圖：本卦/變卦/六親六神世應空亡 新視覺表格
- [ ] 解盤即 ThreadPanel：串流、追問、中止、重試全接通
- [ ] 移除本頁輪詢、手刻 modal、重複 markdown/copy/share 邏輯
